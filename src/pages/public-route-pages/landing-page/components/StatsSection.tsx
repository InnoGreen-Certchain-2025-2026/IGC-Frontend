      ...
      <div className="container mx-auto px-4">
        ...
        >
           <div className="text-center flex-1 px-4 border-b md:border-b-0 md:border-r border-[#336b59] last:border-0 min-w-[200px] py-6 md:py-0 w-full">
              ...
              <p className="text-[#f2ce3c] font-bold text-lg uppercase tracking-wider">{t("landingPage.stats.established")}</p>
           </div>
           <div className="text-center flex-1 px-4 border-b md:border-b-0 md:border-r border-[#336b59] last:border-0 min-w-[200px] py-6 md:py-0 w-full">
              <h3 className="text-5xl lg:text-6xl font-black text-white mb-2">
                 <AnimatedNumber from={0} to={24} duration={2} suffix="/7" />
              </h3>
              <p className="text-[#f2ce3c] font-bold text-lg uppercase tracking-wider">{t("landingPage.stats.support")}</p>
           </div>
           <div className="text-center flex-1 px-4 min-w-[200px] py-6 md:py-0 w-full">
              ...
              <p className="text-[#f2ce3c] font-bold text-lg uppercase tracking-wider">{t("landingPage.stats.responseTime")}</p>
           </div>
        </motion.div>
      </div>
    </section>
