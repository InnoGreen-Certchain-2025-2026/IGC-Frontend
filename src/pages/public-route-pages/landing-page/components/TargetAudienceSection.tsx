      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 max-w-6xl mx-auto">
           <motion.div 
             ...
             viewport={{ once: true }}
             className="flex flex-col items-center text-center p-6 md:p-8 rounded-[2rem] md:rounded-[2.5rem] border-2 border-slate-50 hover:border-[#f2ce3c] hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 bg-slate-50 hover:bg-white group"
           >
             <div className="h-32 md:h-40 flex items-center justify-center mb-6 md:mb-8 mix-blend-multiply group-hover:scale-110 transition-transform duration-500">
