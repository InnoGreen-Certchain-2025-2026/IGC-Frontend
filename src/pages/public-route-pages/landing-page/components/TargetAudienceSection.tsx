    ...
    <section className="py-24 bg-white relative">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-20">
           <h2 className="text-5xl md:text-6xl font-black text-[#214e41] uppercase tracking-tight">Đối tượng hướng đến</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto">
           ...
           >
             ...
             <h3 className="text-3xl font-black text-[#214e41] mb-2">Đại học</h3>
             <p className="text-slate-500 font-bold tracking-widest uppercase text-sm">Đơn vị đào tạo</p>
           </motion.div>
           ...
           >
             ...
             <h3 className="text-3xl font-black text-[#214e41] mb-2">Sinh viên</h3>
             <p className="text-slate-500 font-bold tracking-widest uppercase text-sm">Người học</p>
           </motion.div>
           ...
           >
             ...
             <h3 className="text-3xl font-black text-[#214e41] mb-2">Tổ chức</h3>
             <p className="text-slate-500 font-bold tracking-widest uppercase text-sm">Doanh nghiệp tuyển dụng</p>
           </motion.div>
        </div>
      </div>
    </section>
