 ...
 * Displays the user's blockchain certificates with status badges.
 */
  ...
  return (
    <div>
      <p className="text-gray-500 mb-6">
        Quản lý và chia sẻ bằng cấp blockchain của bạn.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {dummyCerts.map((cert) => (
          <Card
            key={cert.id}
            className="hover:border-blue-500 transition-colors shadow-sm"
          >
